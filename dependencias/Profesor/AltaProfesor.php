...
<div class="col-md-10">
  <div class="page-header">
    <h1>ALTA <small class="texto-verde">NUEVO PROFESOR</small></h1>
  </div>
  <form class="form-horizontal" action="../../controlador/Tareas/agregaprofesor.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        	<input type="text" class="form-control" name="cn_nombreU" placeholder="INGRESA USUARIO" pattern="[a-z]+{30}" required>           
      </div>
    </div>
    <div class="form-group">
		...
		<div class="col-md-3" align="center">
           <a href="../../workflow/Workpage/workspaceA.php" class="btn btn-danger btn-block">REGRESAR</a>
        </div>
        <div class="col-md-1" align="center">
