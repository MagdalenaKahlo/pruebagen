...
if(isset($_SESSION["matricula"]) and isset($_SESSION['tipo_usuario'])){
	if($_SESSION['tipo_usuario']==1){
		if(isset($_REQUEST['ELIMINAR'])){
			...
			$query="DELETE FROM preguntas WHERE id_pregunta='".$_GET['cn_pre']."'";
			$result = $con-> query($query);
			mysqli_close($con);
			header("location:operacionpo.php?cn_materia=".$_REQUEST['cn_materia']);
		}
		if(isset($_POST['AGREGARPRE'])){
			require("../../entidades/Bases de datos/conexion.php");
			$query="INSERT INTO preguntas(id_materia, pregunta, opc1, opc2, opc3, opc4, resp_correcta, id_profesor) VALUES ('".$_REQUEST['cn_materia']."', '".htmlentities($_REQUEST['cn_pregunta'])."', '".htmlentities($_REQUEST['cn_opc1'])."', '".htmlentities($_REQUEST['cn_opc2'])."', '".htmlentities($_REQUEST['cn_opc3'])."', '".htmlentities($_REQUEST['cn_opc4'])."', '".htmlentities($_REQUEST['cn_resp'])."', '".htmlentities($_SESSION["matricula"])."')";
...
<table width="1000" border="0" align="center">
  <tbody>
    <tr>
      <td colspan="6" align="center"><font face="Impact" color="#323232" size="6">Registrar Pregunta Opcion Multiple</font><br/><br/></td>
    </tr>
    <tr>
      <td align="center"><font face="Impact" color="#323232" size="3">Pregunta</font><br/></td>
      <td align="center" width="100"><font face="Impact" color="#323232" size="3">Opcion 1</font><br/></td>
      <td align="center" width="100"><font face="Impact" color="#323232" size="3">Opcion 2</font><br/></td>
      <td align="center" width="100"><font face="Impact" color="#323232" size="3">Opcion 3</font><br/></td>
      <td align="center" width="100"><font face="Impact" color="#323232" size="3">Opcion 4</font><br/></td>
    ...
    <tr>
      ...
      <td align="center" width="100"><input type="text" class="form-control" name="cn_opc1" placeholder="OPC 1" required></td>
      <td align="center" width="100"><input type="text" class="form-control" name="cn_opc2" placeholder="OPC 2" required></td>
      <td align="center" width="100"><input type="text" class="form-control" name="cn_opc3" placeholder="OPC 3" required></td>
      <td align="center" width="100"><input type="text" class="form-control" name="cn_opc4" placeholder="OPC 4" required></td>
      <td align="center" width="100"><input type="text" class="form-control" name="cn_resp" placeholder="RESP" required></td>
    </tr>
    <tr>
...
<table width="600" border="1" align="center" bordercolor="#1DA8D3">
  <tbody>
    ...
    <?php
	require("../../entidades/Bases de datos/conexion.php");
	$query="SELECT * FROM preguntas where id_materia=".$_REQUEST['cn_materia']." and id_profesor='".$_SESSION["matricula"]."'";
	$result = $con-> query($query);
